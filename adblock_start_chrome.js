//console.log("adblock_start_chrome.js");

var elementPurger = {
	
  onPurgeRequest: function(request, sender, sendResponse) {
  	
  	//console.log("elementPurger.onPurgeRequest");
  ...
  _purgeElements: function(request, lastTry) {
    ...
    for (var i=0; i < srcdata.length; i++) {
      ...
      for (var tag in tags[elType]) {
        ...
        //log("[RESULTS]", "  ", results.length, "results for selector:", selector, results);
...
adblock_begin({
  startPurger: function() {
  	//console.log("adblock_begin.startPurger");
    chrome.extension.onRequest.addListener(elementPurger.onPurgeRequest);
    //console.log("adblock_begin.startPurger-done");
  },
  stopPurger: function() {
